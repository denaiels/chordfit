...
//    var minutes: Int = 0
//    let chords : Array = [
//        movingCP(romawiDetail: "I", chordDetail: "C", chordLong: 4),
//        movingCP(romawiDetail: "IV", chordDetail: "F", chordLong: 4),
//        movingCP(romawiDetail: "V", chordDetail: "G", chordLong: 5),
//        movingCP(romawiDetail: "VI", chordDetail: "A", chordLong: 5)
//
//    ]
//
//    var counter = 0
...
//
////    func makeChords(romawi : String, chord : String, beat: Int){
////        chords.append(movingCP(romawiDetail: romawi, chordDetail: chord, beatDetail: beat))
////    }
//
////    func readSong(chords : Array){
////        for chord in chords {
////            makeChords(romawi: chord[0], chord: chord[3], beat: chord[1])
////        }
////    }
//
//    func startCounter(){
...
//                self.createNot2Bit(speed: 5.0, chorddetail: self.chords[n].chordDetail, progressiondetail: self.chords[n].romawiDetail)
...
////        addChild(gambar1)
//
//        let round = SKShapeNode(rect: CGRect(x: 0, y: 0, width: frame.size.width/2, height: 50))
//        round.fillColor = .white
//        round.position = CGPoint(x: frame.midX - frame.size.width/3.6 , y: frame.maxY - 400)
//        round.zPosition = -2
//        worldNode.addChild(round)
//        print(round.frame.width)
//        round.path = UIBezierPath(roundedRect: CGRect(x: 0, y: -200, width: frame.size.width/1.8, height: 35), cornerRadius: 50).cgPath
//        print(round.frame.width)
...
////        songName.position = CGPoint(x: frame.minX + 180, y: frame.maxY - 130)
//
//
//
...
//        artistName.position = CGPoint(x: frame.minX + 350, y: frame.maxY - 170)
//        artistName.fontColor = SKColor.black
//        artistName.horizontalAlignmentMode = .right
//        addChild(artistName)
...
//        let progressionDetail = SKLabelNode(fontNamed: "Arial-Bold")
...
//        let chordDetail = SKLabelNode(fontNamed: "Arial-Bold")
...
class GameScene: SKScene {
    ...
    var minutes: Int = 0
    let chords : Array = [
        movingCP(romawiDetail: "I", chordDetail: "C", chordLong: 3.15),
        movingCP(romawiDetail: "V", chordDetail: "G", chordLong: 3.15),
        movingCP(romawiDetail: "VI", chordDetail: "Am", chordLong: 3.15),
        movingCP(romawiDetail: "IV", chordDetail: "F", chordLong: 3.15),
        movingCP(romawiDetail: "I", chordDetail: "C", chordLong: 3.15),
        movingCP(romawiDetail: "V", chordDetail: "G", chordLong: 3.15),
        movingCP(romawiDetail: "VI", chordDetail: "Am", chordLong: 3.15),
        movingCP(romawiDetail: "IV", chordDetail: "F", chordLong: 3.15),
        movingCP(romawiDetail: "I", chordDetail: "C", chordLong: 3.15),
        movingCP(romawiDetail: "V", chordDetail: "G", chordLong: 3.25),
        movingCP(romawiDetail: "VI", chordDetail: "Am", chordLong: 3.25),
        movingCP(romawiDetail: "IV", chordDetail: "F", chordLong: 3.25),
        movingCP(romawiDetail: "I", chordDetail: "C", chordLong: 3.25),
        movingCP(romawiDetail: "V", chordDetail: "G", chordLong: 3.25),
        movingCP(romawiDetail: "VI", chordDetail: "Am", chordLong: 3.25),
        movingCP(romawiDetail: "IV", chordDetail: "F", chordLong: 3.25)
